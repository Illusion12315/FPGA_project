...
// Command     : write_verilog -force -mode synth_stub -rename_top fifo_pcie_us -prefix
//               fifo_pcie_us_ fifo_pcie_ds_stub.v
// Design      : fifo_pcie_ds
...
module fifo_pcie_us(rst, wr_clk, rd_clk, din, wr_en, rd_en, dout, full, 
  empty, prog_full)

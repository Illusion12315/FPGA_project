...
always@(*)begin
    case (state)
        TX_IDLE        : fifo_us_data_r <= 16'h1234 ;
        TX_SYNC        : fifo_us_data_r <= 16'hEB90 ;
        TX_PACKEGE_H   : fifo_us_data_r <= (package_cnt == 'd0)?16'hEB90 : 16'h1234 ;//package_cnt[31:16] ;

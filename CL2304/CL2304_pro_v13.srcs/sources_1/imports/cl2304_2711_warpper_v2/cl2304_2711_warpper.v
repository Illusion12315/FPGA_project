...
reg                                     RKLSB_r1 = 'd0,RKLSB_r2 = 'd0;
reg                                     RKMSB_r1 = 'd0,RKMSB_r2 = 'd0;
reg                    [  15:0]         RX_Data_r1 = 'd0,RX_Data_r2 = 'd0;
// ********************************************************************************** // 
//---------------------------------------------------------------------
// async 
//---------------------------------------------------------------------
...
assign write_data_en = (data_mod_r2)? fifo_ds_rdreq : fifo_ds_rdreq_o;
assign data_in = (!hf_lb_en_r2)? fifo_ds_q : {fifo_ds_q[7:0],fifo_ds_q[15:8]} ;
...
// debug
//---------------------------------------------------------------------
// ila_2711_rx_debug ila_2711_rx_debug_inst (

...
// Date        : Mon Sep 18 14:15:01 2023
// Host        : Lian-Book running 64-bit major release  (build 9200)
// Command     : write_verilog -mode synth_stub D:/09_Mod/04_EDF_File/ddr3_2g_once64/ddr3_2g_4ch_fsm.v
// Design      : ddr3_2g_4ch_fsm
...
module ddr3_2g_4ch_fsm(log_clk, log_rst_n, phy_init_done, 
...
/* synthesis syn_black_box black_box_pad_pin="log_clk,log_rst_n,phy_init_done,ddr3_fifo_usedw[111:0],fifo_rdreq_ddr3_us[3:0],fifo_q_ddr3_us[2047:0],fifo_prog_empty_ddr3_us[3:0],app_en,app_cmd[2:0],app_addr[27:0],app_rdy,app_wdf_wren,app_wdf_data[511:0],app_wdf_mask[63:0],app_wdf_end,app_wdf_rdy,app_rd_data_valid,app_rd_data[511:0],app_rd_data_end,fifo_wrreq_ddr3_ds[3:0],fifo_data_ddr3_ds[2047:0],fifo_prog_full_ddr3_ds[3:0]" */;
  input log_clk;
  input log_rst_n;
  input phy_init_done;

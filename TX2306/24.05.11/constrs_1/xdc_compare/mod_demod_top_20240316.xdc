...
set_property PACKAGE_PIN AR38 [get_ports {dat_in_p[0]}]
set_property PACKAGE_PIN AR37 [get_ports {dat_in_p[1]}]
set_property PACKAGE_PIN AN38 [get_ports {dat_in_p[2]}]
set_property PACKAGE_PIN AT41 [get_ports {dat_in_p[3]}]
set_property PACKAGE_PIN AV40 [get_ports clk_in_p]

set_property PACKAGE_PIN AW37 [get_ports {dat_out_p[0]}]
set_property PACKAGE_PIN AT39 [get_ports {dat_out_p[1]}]
set_property PACKAGE_PIN BA37 [get_ports {dat_out_p[2]}]
set_property PACKAGE_PIN AP40 [get_ports {dat_out_p[3]}]
set_property PACKAGE_PIN AU39 [get_ports clk_to_pins_p]
